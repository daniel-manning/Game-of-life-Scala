...
object BoardData {
  ...
  def beehive = List( Cell((0,0), Dead), Cell((1,0), Dead),  Cell((2,0), Dead),  Cell((3,0), Dead),  Cell((4,0), Dead),  Cell((5,0), Dead),
  ...
  def blinker_stage1 = List( Cell((0,0), Dead), Cell((1,0), Dead), Cell((2,0), Dead),  Cell((3,0), Dead), Cell((4,0), Dead),
  ...
  def blinker_stage2 = List( Cell((0,0), Dead), Cell((1,0), Dead),  Cell((2,0), Dead),  Cell((3,0), Dead),  Cell((4,0), Dead),
